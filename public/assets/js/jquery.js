...
jQuery.event = {
	...
	dispatch: function( nativeEvent ) {
		...
		var i, j, ret, matched, handleObj, handlerQueue,
			...
			// Make a writable jQuery.EventLiveWire from the native event object
		...
		// Use the fix-ed jQuery.EventLiveWire rather than the (read-only) native event
		args[ 0 ] = event;
...
// jQuery.EventLiveWire is based on DOM3 Events as specified by the ECMAScript Language Binding
...
jQuery.fn.extend( {
	...
	off: function( types, selector, fn ) {
		...
		if ( types && types.preventDefault && types.handleObj ) {
			...
			// ( event )  dispatched jQuery.EventLiveWire
...
jQuery.extend( jQuery.event, {
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		// Caller can pass in a jQuery.EventLiveWire object, Object, or just an event type string
