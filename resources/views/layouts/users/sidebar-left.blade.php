<ul class="sidebar-nav">
	  ...
	  <li class="nav-item"><a href="index.html" class="nav-link"><i data-feather="layout"></i>Dashboard</a></li>
	  <li class="nav-item"><a href="grid.html" class="nav-link"><i data-feather="grid"></i> Grid System</a></li>
	  <li class="nav-item show">
		<a href="el-avatar.html" class="nav-link with-sub active"><i data-feather="layers"></i> UI Elements</a>
		<nav class="nav">
		  <a href="el-accordion.html">Accordion</a>
		  <a href="el-alerts.html">Alerts</a>
		  <a href="el-avatar.html" class="active">Avatar</a>
	  ...
	  <li class="nav-item show">
		<a href="el-avatar.html" class="nav-link with-sub"><i data-feather="package"></i> Utilities</a>
		<nav class="nav">
	  ...
	  <li class="nav-item show">
		<a href="el-avatar.html" class="nav-link with-sub"><i data-feather="inbox"></i> Forms</a>
		<nav class="nav">
	  ...
	  <li class="nav-item show">
		<a href="el-avatar.html" class="nav-link with-sub"><i data-feather="pie-chart"></i> Charts</a>
		<nav class="nav">
	  ...
	  <li class="nav-item show">
		<a href="el-avatar.html" class="nav-link with-sub"><i data-feather="map-pin"></i> Maps</a>
		<nav class="nav">
