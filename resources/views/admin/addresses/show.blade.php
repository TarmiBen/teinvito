...
@section('title', 'Detalle de la Dirección')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-auto card-subtitle mb-3 text-muted fw-bold">
                                Dirección de la compañia: <a
                                    href="{{ route('admin.companies.show', $address->company) }}">{{ $address->company->name }}</a>
                            </div>
                        </div>
                        <div class="mt-5">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-4 mt-2 d-flex align-items-center">
                                    <span class="fw-bold">
                                        <span class="text-muted">N° Int:</span>
                                        {{ isset($address->int) ? $address->int : 'N/A' }}
                                    </span>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 mt-2 d-flex align-items-center">
                                    <span class="fw-bold">
                                        <span class="text-muted">N° Ext</span>
                                        {{ isset($address->ext) ? $address->ext : 'N/A' }}
                                    </span>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 mt-2 d-flex align-items-center">
                                    <span class="fw-bold">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 mt-2 d-flex align-items-center">
                                    <span class="fw-bold">
                                        <span class="text-muted">Colonia:</span>
                                        {{ isset($address->colony) ? $address->colony : 'N/A' }}
                                    </span>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 mt-2 d-flex align-items-center">
                                    <span class="fw-bold">
                                        <span class="text-muted">Calle:</span>
                                        {{ isset($address->street) ? $address->street : 'N/A' }}
                                    </span>
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 mt-2 d-flex align-items-center">
                                    <span class="fw-bold">
                                        <span class="text-muted">Estado:</span>
                                        {{ isset($address->state) ? $address->state : 'N/A' }}
                                    </span>
                                </div>
                            </div>
                        </div>
